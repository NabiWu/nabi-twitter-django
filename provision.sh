...
sudo dpkg mysql-apt-config_0.8.15-1_all.deb
...
# 换源完美解决
# 安装pip所需依赖
pip install --upgrade setuptools https://pypi.tuna.tsinghua.edu.cn/simple
pip install --ignore-installed wrapt https://pypi.tuna.tsinghua.edu.cn/simple
# 安装pip最新版
pip install -U pip https://pypi.tuna.tsinghua.edu.cn/simple
